...
<?php include("include/header.php");?>
	...
	if ($b1num<1 OR $b2num<1 OR $b3num<1 OR $b4num<1 OR $b5num<1 OR $b6num<1 OR $b7num<1 OR $b8num<1 OR $b9num<1 OR $b10num<1 OR $b11num<1 OR $b12num<1 OR $b13num<1 OR $b14num<1 OR $b15num<1 OR $teachernum<1 OR $studentnum<1 OR $c1num<1 OR $c2num<1 OR $c3num<1 OR $c4num<1 OR $c5num<1 OR $c6num<1 OR $c7num<1 OR $c8num<1 OR $c9num<1 OR $c10num<1 OR $c11num<1 ) {
		if ($c1num<1) {
		...
		echo "ไม่สามารถดำเนินการได้เนื่องจาก<br>".$c1echo.$c2echo.$c3echo.$c4echo.$c5echo.$c6echo.$c7echo.$c8echo.$c9echo.$c10echo.$c11echo.$b1echo.$b2echo.$b3echo.$b4echo.$b5echo.$b6echo.$b7echo.$b8echo.$b9echo.$b10echo.$b11echo.$b12echo.$b13echo.$b14echo.$b15echo.$teachernum.$studentnum."<br><br><br><br><br>";
	}else{
