...
if ($b5num > 0) {
		mysql_query("UPDATE `b5` SET `5_1` = '".$_POST["txt5_1"]."',`5_2` = '".$_POST["txt5_2"]."',`5_3` = '".$_POST["txt5_3"]."',`5_4` = '".$_POST["txt5_4"]."'") or die (mysql_error());
}else{
		mysql_query("insert into b5(schoolid, `5_1`,`5_2`,`5_3`,`5_4`) values ('".$_SESSION['ses_username']."','".$_POST["txt5_1"]."','".$_POST["txt5_2"]."','".$_POST["txt5_3"]."','".$_POST["txt5_4"]."')") or die(mysql_error());
}

$message = "บันทึกข้อมูลเรียบร้อย";
	echo "<script type='text/javascript'>alert('$message');</script>";
	echo "<meta http-equiv='refresh' content='0;URL=basic5.php'>";
mysql_close($Conn); 
}
?>