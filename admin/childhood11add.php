...
if ($c11num > 0) {
		mysql_query("UPDATE `c11` SET `11_1` = '".$_POST["txt11_1"]."',`11_2` = '".$_POST["txt11_2"]."' WHERE `schoolid` = '".$_POST['txtschoolid']."'") or die (mysql_error());
}else{
		mysql_query("insert into c11(schoolid, `11_1`,`11_2`) values ('".$_POST['txtschoolid']."','".$_POST["txt11_1"]."','".$_POST["txt11_2"]."')") or die(mysql_error());
}

$message = "บันทึกข้อมูลเรียบร้อย";
	echo "<script type='text/javascript'>alert('$message');</script>";
	echo "<meta http-equiv='refresh' content='0;URL=childhood11sel.php'>";
mysql_close($Conn); 
}
?>