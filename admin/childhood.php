...
<?php include("include/navbar.php");?>
  	<form id="form1" name="form1" method="post" action="">
		...
		<table align="center" width="100%" class="table table-bordered">
			...
			<div class="row">
				<div align="center">
				<input class="btn btn-primary" type="button" name="Button" value="นำออกข้อมูล" onClick="window.location.href='exportschildhood.php?txtschoolid=<?php echo $_GET['txtschoolid'];?>'">
				<br>
				<br> 
				</div>
			</div>
