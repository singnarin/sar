		...
		<table align="center" width="100%" class="table table-bordered">
			...
			<tr>
  			...
  			<tr>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_1_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_1_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_1_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_1_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_1_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_2_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_2_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_2_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_2_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_2_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_3_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_3_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_3_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_3_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_3_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_4_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_4_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_4_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_4_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c1num > 0) {
						echo "value=\"".$c1Result['total1_4_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
