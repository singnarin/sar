		...
		<table align="center" width="100%" class="table table-bordered">
			...
			<tr>
  			...
  			<tr>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_1_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_1_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_1_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_1_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_1_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_2_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_2_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_2_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_2_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_2_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_3_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_3_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_3_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_3_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_3_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_4_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_4_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_4_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_4_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c3num > 0) {
						echo "value=\"".$c3Result['total3_4_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
