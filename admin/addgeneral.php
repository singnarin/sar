...
if ($teachernum > 0) {
	...
	$txtprimaryhigh = $_POST["txthighschoolteacher"] + $_POST["txtprimaryteacher"];
		mysql_query("insert into teacher(schoolid, mDirector,fDirector,mDeputy,fDeputy,mRegular,fRegular,mRate,fRate,fJanitor,mJanitor,mTemp,fTemp,sumteacher,childteacher,primaryteacher,highschoolteacher,primaryhigh) values ('".$_POST['txtschoolid']."','".$_POST["txtmdirector"]."','".$_POST["txtfdirector"]."','".$_POST["txtmdeputy"]."','".$_POST["txtfdeputy"]."','".$_POST["txtmregular"]."','".$_POST["txtfregular"]."','".$_POST["txtmrate"]."','".$_POST["txtfrate"]."','".$_POST["txtfjanitor"]."','".$_POST["txtmjanitor"]."','".$_POST["txtmtemp"]."','".$_POST["txtftemp"]."','".$_POST["txtsumteacher"]."','".$_POST["txtchildteacher"]."','".$_POST["txtprimaryteacher"]."','".$_POST["txthighschoolteacher"]."','".$txtprimaryhigh."')") or die(mysql_error());
}
