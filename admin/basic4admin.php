		...
		<table align="center" width="100%" class="table table-bordered">
			...
			<tr>
  			...
  			<tr>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_1_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_1_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_1_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_1_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_1_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_2_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_2_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_2_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_2_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_2_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_3_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_3_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_3_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_3_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_3_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_4_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_4_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_4_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_4_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($b4num > 0) {
						echo "value=\"".$b4Result['total4_4_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
