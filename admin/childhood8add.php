...
if ($c8num > 0) {
		mysql_query("UPDATE `c8` SET `8_1` = '".$_POST["txt8_1"]."',`8_2` = '".$_POST["txt8_2"]."',`8_3` = '".$_POST["txt8_3"]."',`8_4` = '".$_POST["txt8_4"]."',`8_5` = '".$_POST["txt8_5"]."',`8_6` = '".$_POST["txt8_6"]."' WHERE `schoolid` = '".$_POST['txtschoolid']."'") or die (mysql_error());
}else{
