...
<?php
	if ($_SESSION['ses_username']=="56010000"){	
		...
		if ($teachernum > 0) {
			...
			$teacherResult["totalchildteacher"] = 0 ;
		}	
		...
		<table align="center" width="100%" class="table table-bordered">
			...
			<tr>
  			...
  			<tr>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_1_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_1_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_1_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_1_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_1_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
				...
				?>
  				...
  				<td><div align="center">
  				<?php
  				if ($c5num > 0 && $teacherResult["totalchildteacher"] != 0) {
  			...
  			<tr>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_2_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_2_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_2_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_2_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_2_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_3_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_3_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_3_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_3_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_3_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_4_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_4_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_4_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_4_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_4_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_5_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_5_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_5_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_5_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_5_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_6_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_6_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_6_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_6_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_6_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_7_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_7_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_7_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_7_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_7_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_8_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_8_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_8_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_8_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_8_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_9_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_9_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_9_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_9_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_9_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_10_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_10_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_10_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_10_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c5num > 0) {
						echo "value=\"".$c5Result['total5_10_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
