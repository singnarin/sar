...
<body>
<form id="form1" name="form1" method="post" action="../admin/basic14.php">
<?php
	...
	<div class="row-fluid">
  	  <div class="bg"><?php include("include/navbar.php");?>
  	  	<div align="center">
  	  		<div class="container">
				<div class="row">
  	  			<h4>มาตรฐานที่ 14  การพัฒนาสถานศึกษาให้บรรลุเป้าหมายตามวิสัยทัศน์ ปรัชญาและจุดเน้นที่กำหนดขึ้น</h4>
  	  			</div>
				<div class="row">
					<br>
