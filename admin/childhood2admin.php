		...
		<table align="center" width="100%" class="table table-bordered">
			...
			<tr>
  			...
  			<tr>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_1_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_1_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_1_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_1_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_1_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_2_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_2_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_2_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_2_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_2_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_3_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_3_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_3_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_3_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_3_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
  			...
  			<tr>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_4_1']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_4_2']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_4_3']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_4_4']."\"";
						}
				?>
				/></td>
				...
				<?php 
				if ($c2num > 0) {
						echo "value=\"".$c2Result['total2_4_5']."\"";
						}
				?>
				/></td>
  				<td><div align="center">
