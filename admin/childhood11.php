	...
	if ($_SESSION['ses_username']=="56010000"){	
			if ($_POST['txtschoolid']!=""){	
				if ($_POST['txtschoolid']=="56010000") {
					echo "<meta http-equiv='refresh' content='0;URL=childhood11admin.php'>";
				}else{
		$schoolResult = mysql_fetch_array(mysql_query("SELECT * FROM `tbschool` WHERE `schoolid` = '".$_POST['txtschoolid']."'")) or die  (mysql_error());

		$selc11 = mysql_query("SELECT * FROM `c11` WHERE `schoolid` = '".$_POST['txtschoolid']."'");
...
<?php include("include/navbar.php");?>
  	...
  	<form id="form1" name="form1" method="post" action="childhood11add.php">
		<table align="center" width="100%" class="table table-bordered">
			<tr>
				<td colspan="10"><div align="center"><br><h4>ผลการพัฒนามาตรฐานที่ 11  การพัฒนาสถานศึกษาตามนโยบายและแนวทางปฏิรูปการศึกษา</h4></div></td>
			</tr>
			<tr>
