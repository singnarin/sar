...
if ($c3num > 0) {
		...
		mysql_query("insert into c3(schoolid, 3_1_1,3_1_2,3_1_3,3_1_4,3_1_5,3_2_1,3_2_2,3_2_3,3_2_4,3_2_5,3_3_1,3_3_2,3_3_3,3_3_4,3_3_5,3_4_1,3_4_2,3_4_3,3_4_4,3_4_5) values ('".$_POST['txtschoolid']."', '".$_POST["txt3_1_1"]."','".$_POST["txt3_1_2"]."','".$_POST["txt3_1_3"]."','".$_POST["txt3_1_4"]."','".$_POST["txt3_1_5"]."','".$_POST["txt3_2_1"]."','".$_POST["txt3_2_2"]."','".$_POST["txt3_2_3"]."','".$_POST["txt3_2_4"]."','".$_POST["txt3_2_5"]."','".$_POST["txt3_3_1"]."','".$_POST["txt3_3_2"]."','".$_POST["txt3_3_3"]."','".$_POST["txt3_3_4"]."','".$_POST["txt3_3_5"]."','".$_POST["txt3_4_1"]."','".$_POST["txt3_4_2"]."','".$_POST["txt3_4_3"]."','".$_POST["txt3_4_4"]."','".$_POST["txt3_4_5"]."')") or die(mysql_error());
}

$message = "บันทึกข้อมูลเรียบร้อย";
	echo "<script type='text/javascript'>alert('$message');</script>";
	echo "<meta http-equiv='refresh' content='0;URL=childhood3sel.php'>";
}
}else{
