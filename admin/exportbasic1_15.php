...
<?php
	if ($_SESSION['ses_username']=="56010000"){	
		...
		$teacherResult = mysql_fetch_array(mysql_query("SELECT * FROM `teacher` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b1Result = mysql_fetch_array(mysql_query("SELECT * FROM `b1` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b2Result = mysql_fetch_array(mysql_query("SELECT * FROM `b2` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b3Result = mysql_fetch_array(mysql_query("SELECT * FROM `b3` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b4Result = mysql_fetch_array(mysql_query("SELECT * FROM `b4` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b5Result = mysql_fetch_array(mysql_query("SELECT * FROM `b5` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b6Result = mysql_fetch_array(mysql_query("SELECT * FROM `b6` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b7Result = mysql_fetch_array(mysql_query("SELECT * FROM `b7` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b8Result = mysql_fetch_array(mysql_query("SELECT * FROM `b8` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b9Result = mysql_fetch_array(mysql_query("SELECT * FROM `b9` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b10Result = mysql_fetch_array(mysql_query("SELECT * FROM `b10` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b11Result = mysql_fetch_array(mysql_query("SELECT * FROM `b11` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b12Result = mysql_fetch_array(mysql_query("SELECT * FROM `b12` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b13Result = mysql_fetch_array(mysql_query("SELECT * FROM `b13` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b14Result = mysql_fetch_array(mysql_query("SELECT * FROM `b14` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$b15Result = mysql_fetch_array(mysql_query("SELECT * FROM `b15` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
