...
<?php
	if ($_SESSION['ses_username']=="56010000"){	
		...
		$studentResult = mysql_fetch_array(mysql_query("SELECT * FROM `student` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$teacherResult = mysql_fetch_array(mysql_query("SELECT * FROM `teacher` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c1Result = mysql_fetch_array(mysql_query("SELECT * FROM `c1` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c2Result = mysql_fetch_array(mysql_query("SELECT * FROM `c2` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c3Result = mysql_fetch_array(mysql_query("SELECT * FROM `c3` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c4Result = mysql_fetch_array(mysql_query("SELECT * FROM `c4` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c5Result = mysql_fetch_array(mysql_query("SELECT * FROM `c5` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c6Result = mysql_fetch_array(mysql_query("SELECT * FROM `c6` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c7Result = mysql_fetch_array(mysql_query("SELECT * FROM `c7` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c8Result = mysql_fetch_array(mysql_query("SELECT * FROM `c8` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c9Result = mysql_fetch_array(mysql_query("SELECT * FROM `c9` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c10Result = mysql_fetch_array(mysql_query("SELECT * FROM `c10` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
		$c11Result = mysql_fetch_array(mysql_query("SELECT * FROM `c11` WHERE `schoolid` = '".$_GET['txtschoolid']."'")) or die  (mysql_error());
