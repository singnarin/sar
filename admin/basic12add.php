...
if ($b12num > 0) {
		mysql_query("UPDATE `b12` SET `12_1` = '".$_POST["txt12_1"]."',`12_2` = '".$_POST["txt12_2"]."',`12_3` = '".$_POST["txt12_3"]."',`12_4` = '".$_POST["txt12_4"]."',`12_5` = '".$_POST["txt12_5"]."',`12_6` = '".$_POST["txt12_6"]."' WHERE `schoolid` = '".$_POST['txtschoolid']."'") or die (mysql_error());
}else{
...
$message = "บันทึกข้อมูลเรียบร้อย";
	echo "<script type='text/javascript'>alert('$message');</script>";
	echo "<meta http-equiv='refresh' content='0;URL=basic12sel.php'>";
mysql_close($Conn); 
}
?>